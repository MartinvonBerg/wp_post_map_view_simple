...
wp_enqueue_style('bootstrap_table_css',         $plugin_url . 'css/bootstrap-table.min.css', '', '1.19.1');
...
wp_enqueue_script('bootstrap_table_js',                    $plugin_url . 'js/bootstrap-table-1-19-1.js', array('jquery'), '1.19.1', true);
wp_enqueue_script('bootstrap_table_locale_all_js',         $plugin_url . 'js/bootstrap-table-locale-all.min.js', array('jquery'), '1.19.1', true);
