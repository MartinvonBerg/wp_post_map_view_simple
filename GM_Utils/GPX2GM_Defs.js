...
JB.GPX2GM.setparameters = function() {  
	...
	JB.GPX2GM.parameters.unit = (typeof(Unit)!="undefined") ? Unit : "si"; // enus oder air oder water = airwater
	...
	JB.GPX2GM.parameters.hfaktor = (typeof(Hfaktor)!="undefined") ? Hfaktor : 1;
	JB.GPX2GM.parameters.sfaktor = (typeof(Sfaktor)!="undefined") ? Sfaktor : 1;
	JB.GPX2GM.parameters.vfaktor = (typeof(Vfaktor)!="undefined") ? Vfaktor : 1;
	JB.GPX2GM.parameters.wfaktor = (typeof(Wfaktor)!="undefined") ? Wfaktor : 1;
	...
	JB.GPX2GM.parameters.shtrt = (typeof(Shtrt)!="undefined") ? Shtrt : false; // Martin
