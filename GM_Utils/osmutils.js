...
//		layers: osm, 
	...
	JB.onresize(mapcanvas,function(w,h){
		if(w>200 && h>200 && makemap.parameters.showmaptypecontroll) { // Martin
...
JB.Infofenster = function(map){
	...
	Infofenster_O.prototype.hide = function() { 
		this.fenstercontainer.hidden = false; // Martin
	}
