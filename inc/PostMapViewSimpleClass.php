...
final class PostMapViewSimple implements PostMapViewSimpleInterface {
	...
	public function show_post_map(): string {
        ...
        wp_enqueue_style('wp_pmtv_main_css', $plugin_url . 'css/wp_post_map_view_simple.css', [], '1.3.0', 'all');
        wp_enqueue_script('wp_pmtv_main_js', $plugin_url . 'build/pmtv_main.js', [], '1.3.0', true);
    ...
    private function enqueue_tabulator_Theme($theme) {
        ...
        // Load default Styles
        if ( $theme == '' ) {
            wp_enqueue_style('tabulator_css', $plugin_url . 'css/tabulator.min.css', [], '1.3.0', 'all');
        } else {
            wp_enqueue_style('tabulator_css', $plugin_url . 'css/' . $themes[$theme], [], '1.3.0', 'all');
        }
    }
