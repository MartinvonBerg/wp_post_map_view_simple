...
class WpPostMapViewSimpleTest extends TestCase
{
    public function setUp(): void
    {
        ...
        expect('add_shortcode')
            ->andReturn(true);
        require_once 'C:\Bitnami\wordpress-6.0.1-0\apps\wordpress\htdocs\wp-content\plugins\PostMapTableView\inc\post_map_table.php';
        setUp();
    }
