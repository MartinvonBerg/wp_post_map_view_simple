...
(function (window, document, $, undefined) {
    ...
    if (numberOfboxes == 1) {
        ...
        $('a').each(function (index, value) { // Achtung: geht nur, wenn die Marker als <a> auf der Seite erzeugt werden und sonst keine a-Elemente mit geo-daten vorhanden sind
